...
export default function Contact() {
  return (
    <div className='mx-10 md:mr-0 md:ml-24 xl:ml-40 mt-16'>
      ...
      <p className="font-semibold text-sm md:text-base text-gray-600 mb-10 md:pr-40 lg:pr-0 lg:w-4xl">LET’S CONNECT: WE’RE HERE TO HELP, AND WE’D LOVE TO HEAR FROM YOU! WHETHER YOU HAVE A QUESTION, COMMENT, OR JUST WANT TO CHAT , YOU CAN REACH OUT TO US THROUGH THE CONTACT FORM OF THIS PAGE, OR BY PHONE, EMAIL, OR SOCIAL MEDIA.</p>
